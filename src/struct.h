...
typedef struct well{ // Definition of the structure of a well, is used internal
  int col;
  int row;
...
typedef struct well_raw{ // Definition for a well, used when define a well externally. 
  int col;
  int row;
